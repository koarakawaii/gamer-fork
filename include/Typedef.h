...
const TestProbID_t
   ...
   TESTPROB_ELBDM_BLACK_HOLE_IN_HALO                      = 1021,
   TESTPROB_ELBDM_BLACK_HOLE_IN_SOLITON                   = 1022,
   TESTPROB_ELBDM_CORRELATION_FUNCTION                    = 1023,
   TESTPROB_ELBDM_SOLITON_TOY_MODEL                       = 1024,
   TESTPROB_ELBDM_HALO_STABILITY_TEST_NO_SOLITON          = 1025,
   TESTPROB_ELBDM_HALO_STABILITY_TEST_SOLITON_SUBSTITUTED = 1026;
