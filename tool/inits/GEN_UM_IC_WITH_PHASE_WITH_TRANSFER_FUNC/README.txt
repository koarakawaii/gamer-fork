...
(c) Modifying the cosmology paramters to be consistent with CAMB/axionCAMB .ini files, as well as the input file parameters in ics_example.conf:
        transfer      = camb_file
        transfer_file = planck_2018_axion_transfer_out_no_vel.dat/planck_2018_axion_transfer_out_no_vel.dat
        format        = generic
        filename      = planck_2018_tf_no_vel.hdf5/planck_2018_axion_tf_no_vel.hdf5
    Then run the MUSIC: "./MUSIC ics_example.conf".
