...
// ********************************************************************************************************************************
   ...
   ReadPara->Add( "System_CM_TolErrR",        &System_CM_TolErrR,       Eps_double,      Eps_double,      NoMax_double      );
   ReadPara->Add( "Soliton_CM_MaxR",          &Soliton_CM_MaxR,        NoMax_double,     Eps_double,       NoMax_double      );
   ReadPara->Add( "Soliton_CM_TolErrR",       &Soliton_CM_TolErrR,      Eps_double,      Eps_double,      NoMax_double      );
...
// Description :  Store the initial density and modulate the phase of center region
//
