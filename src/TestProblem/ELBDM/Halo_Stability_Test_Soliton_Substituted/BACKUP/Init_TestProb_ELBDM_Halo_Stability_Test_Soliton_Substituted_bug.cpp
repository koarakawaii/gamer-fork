...
// if restart and reset the time ticks to 0, then OPT__RESET_FLUID must be set to 1 (enabled)
   if ( (OPT__RESTART_RESET == 1) && (OPT__RESET_FLUID != 1) )
      Aux_Error( ERROR_INFO, "OPT__RESET_FLUID must be set to 1 when OPT__RESTART_RESET is set to 1, to substitute center region by analytical soliton!!\n" );
