...
#  endif
   ...
   LoadField( "BoxEdgeL",        KeyInfo.BoxEdgeL,       H5_SetID_KeyInfo, H5_TypeID_KeyInfo,    Fatal,  amr->BoxEdgeL, 3,    Fatal );
   LoadField( "BoxEdgeR",        KeyInfo.BoxEdgeR,       H5_SetID_KeyInfo, H5_TypeID_KeyInfo,    Fatal,  amr->BoxEdgeR, 3,    Fatal );
   } // if ( KeyInfo.FormatVersion < 2300 ) ... else ...
