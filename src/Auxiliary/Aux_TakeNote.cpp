...
//    record the parameters of simulation scale
      ...
      fprintf( Note, "***********************************************************************************\n" );
      fprintf( Note, "BOX_EDGE_LEFT_X                %+21.14e\n", amr->BoxEdgeL[0]  );
      fprintf( Note, "BOX_EDGE_LEFT_Y                %+21.14e\n", amr->BoxEdgeL[1]  );
      fprintf( Note, "BOX_EDGE_LEFT_Z                %+21.14e\n", amr->BoxEdgeL[2]  );
      fprintf( Note, "BOX_EDGE_RIGHT_X               %+21.14e\n", amr->BoxEdgeR[0]  );
      fprintf( Note, "BOX_EDGE_RIGHT_Y               %+21.14e\n", amr->BoxEdgeR[1]  );
      fprintf( Note, "BOX_EDGE_RIGHT_Z               %+21.14e\n", amr->BoxEdgeR[2]  );
      fprintf( Note, "BOX_CENTER_X                   %+21.14e\n", amr->BoxCenter[0] );
      fprintf( Note, "BOX_CENTER_Y                   %+21.14e\n", amr->BoxCenter[1] );
      fprintf( Note, "BOX_CENTER_Z                   %+21.14e\n", amr->BoxCenter[2] );
